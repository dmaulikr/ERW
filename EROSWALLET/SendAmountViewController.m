...
- (void)viewDidLoad {
   ...
   // self.title = @"SEND";
    ...
    if (_dictACData == NULL) {
        ...
        [alert showWarning:self.parentViewController title:@"ERW" subTitle:@"You Haven't Created Any Account Yet!! Create Account First Then Only You Can Use Send Function!!" closeButtonTitle:nil duration:0.0f];*/
        
        UIAlertController * alert = [UIAlertController
                                     alertControllerWithTitle:@"Alert"
                                     message:@"You Haven't Created Any Account Yet!! Create Account First Then Only You Can Use Send Function!!"
